...
import org.omegat.gui.langproject.PluginLanguage;
...
public class ProjectPropertiesDialog extends JDialog {
    ...
    public ProjectPropertiesDialog(Frame parent, final ProjectProperties projectProperties, String projFileName,
        ...
        final JComboBox<Language> sourceLocaleField = new JComboBox<>(new Vector<>(PluginLanguage.getLanguages()));
        ...
        final JComboBox<Language> targetLocaleField = new JComboBox<>(new Vector<>(PluginLanguage.getLanguages()));
